...
pricingTiers:
  ...
  - label: "5–6 people"
    price: 190
priceIncludes:
  - "Private licensed guide for your family only"
  - "Personalized route and pacing"
  - "Children's activity sheets"
  - "Authentic set of Czech pencils"
  - "Selection of local snacks and sweets to try"
...
## Tour Overview
Travelling with children has its challenges, whether it's finding the right balance of information and entertainment, looking for suitable playgrounds or picking local snacks to try out.
...
- John Lennon Wall
- Kampa Park
- Lesser-known, tranquil park
- Great children's playground

### Topics covered
- Charles Bridge, its statues and its place in our history
- Local legends and folklore including the Golem, Vodník, Rusalky and more (age appropriate)
- Greatest rulers in Czech history brought to life
...
### Extras for parents
- Parents' Booklet to expand upon the concepts of the tour and the mystery game
